...
export default async function PracticeSubscribeSuccessPage() {
  const session = await getPracticeSession();
  if (!session) {
    redirect("/practice/login?next=/practice/subscribe/success");
  }
      ...
      <div className="mx-auto max-w-2xl px-6 py-20 text-center">
        <div className="rounded-3xl border-2 border-emerald-400/40 bg-white p-10 shadow-lg">
          ...
          <ul className="mt-6 space-y-2 text-left text-sm font-bold text-[#1B3A5B]/70">
            ...
            <li>• We&apos;ll register your tablet when your kit is ready</li>
          </ul>
